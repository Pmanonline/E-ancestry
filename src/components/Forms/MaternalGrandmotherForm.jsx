...
//     formDataToSubmit.append("Lstatus", formData.Lstatus); // Ensure Lstatus is included
...
//       // setTimeout(() => navigate("/layout/maternalGrandmother-form"), 2000);
//     }
...
//                 {isEdit ? "Edit here" : "Add maternalGrandMother details"}
//               </h3>
//               <p>
...
//                 name="Lstatus"
//                 value="stillLiving"
//                 checked={formData.Lstatus === "stillLiving"}
//                 onChange={() => handleLstatusChange("stillLiving")}
//                 className="h-4 w-4 text-green-600 focus:ring-green border-gray-300 rounded mr-2"
//               />
//               <label htmlFor="stillLiving" className="block text-sm text-black">
//                 Still Living
//               </label>
//               <input
//                 type="radio"
...
//                     {isEdit ? "Update" : "Click here to continue"}
//                   </span>
//                 )}
//               </button>
//             </div>
...
//                 <Link
//                   to="/layout/maternalGrandmother-form"
